	...
	<body>
		...
		<form action="" method="post">
			<table id="public_area" class="active">
				<tr>
					<td>名前</td>
					<td><input type="text" name="userId" value="${sessionScope.user.userName}"></td>
				<tr>
				<tr>
					<td>ユーザーID</td>
				...
				<tr>
					<td>プロフィール</td>
					<td><input type="text" name="userId" value="${sessionScope.user.profile}"></td>
				<tr>
				<tr>
					<td>プロフィール画像</td>
			...
			<table id="private_area" class="passive">
				<tr>
					<td>メールアドレス</td>
					<td><input type="text" name="userId" value="${sessionScope.user.mailAddress}"></td>
				</tr>
				<tr>
					<td>パスワード</td>
				...
				<tr>
					<td>アカウントの公開範囲</td>
					<td><label>すべてのユーザー<input type="radio" name="release" id="public"><label></td>
					<td>フォロワーのみ<input type="radio" name="release" id="private"></td>
				</tr>
			</table>
