...
-- Users表
	CREATE TABLE Users(
		...
		profilePicture 	VARCHAR2(1000) DEFAULT '初期画像パス' CONSTRAINT NN_Users_profilePicture NOT NULL,
...
-- Post表
	CREATE TABLE Post(
		...
		contents 		VARCHAR2(1000) DEFAULT 'エラー画像' CONSTRAINT NN_Post_contents NOT NULL,
